...
import 'html-escaper';
import { S as Section, F as Form, g as getLangFromUrl, f as fetchGlobalData, P as PageWrapper, c as cave, $ as $$Layout } from './_...artistSlug_.astro.8d409370.mjs';
    ...
    children: jsxs("div", {
      ...
      children: [jsx(DecodeMarkdown, {
        ...
        children: [jsx("a", {
          ...
          children: "Тату-салон в Кишиневе"
        }), jsx("iframe", {
...
const $$Contact$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "image": cave }, { "default": ($$result2) => renderTemplate`
    ${renderComponent($$result2, "PageWrapper", PageWrapper, { "title": layoutData.navList[language][3].text, "main": layoutData.navList[language][0].text }, { "default": ($$result3) => renderTemplate`
        ${renderComponent($$result3, "FindUs", FindUs, { "data": contactsGuide[language] })}
