...
import 'html-escaper';
import { g as getLangFromUrl, d as fetchSectionData, f as fetchGlobalData, P as PageWrapper, S as Section, c as cave, $ as $$Layout } from './_...artistSlug_.astro.91cf3a92.mjs';
import { F as FormSection } from './contact.astro.bbe35a68.mjs';
import { T as Testimonial } from './index.astro.efb7cb35.mjs';
...
const $$Testimonials$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "image": cave }, { "default": ($$result2) => renderTemplate`
    ${renderComponent($$result2, "PageWrapper", PageWrapper, { "title": globalData?.layoutData.navList[language][4].text || "Testimonials", "main": globalData?.layoutData.navList[language][0].text || "Main" }, { "default": ($$result3) => renderTemplate`
        ${renderComponent($$result3, "Section", Section, {}, { "default": ($$result4) => renderTemplate`
            ${renderComponent($$result4, "TestimonialPage", TestimonialPage, { "client:load": true, "cta": globalData?.buttons[language].cta || "book an appointment", "data": testimonialsData, "client:component-hydration": "load", "client:component-path": "pageComponents/TestimonialsPage/TestimonialsPage", "client:component-export": "TestimonialPage" })}
        ` })}
