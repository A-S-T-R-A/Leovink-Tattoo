...
import { s as styles$1, a as styles$2, b as styles$3, c as styles$4, d as styles$5, e as styles$6, f as styles$8, g as styles$9 } from '../_...artistSlug_.87481691.38f06160.mjs';
...
import { s as styles$b, a as styles$c } from '../_...artistSlug_.b11b3c3e.956ad7aa.mjs';
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}>
    ...
    <body>
        ...
        ${renderComponent($$result, "Header", Header, { "client:load": true, "language": language, "defaultLanguage": defaultLanguage, "data": globalData?.layoutData.navList[language] || null, "socialsData": globalData?.socialsData || [], "client:component-hydration": "load", "client:component-path": "widgets/Header", "client:component-export": "Header" }, { "default": ($$result2) => renderTemplate`
            ${renderComponent($$result2, "LogoLink", LogoLink, { "language": language, "defaultLanguage": defaultLanguage })}
        ` })}
        ${renderSlot($$result, $$slots["default"])}
        ${renderComponent($$result, "Footer", Footer, { "data": globalData?.layoutData.footerList[language] || null, "addressData": globalData?.addressData || null, "language": language, "socialsData": globalData?.socialsData || [] }, { "default": ($$result2) => renderTemplate`  
            ${renderComponent($$result2, "LogoLink", LogoLink, { "language": language, "defaultLanguage": defaultLanguage })}
        ` })}
    </body></html>`;
...
function getMaximumColumnHeight(containerRef, columns = 5) {
  if (!containerRef)
    return 5e4;
  const arr = Array(columns).fill(0);
  Array.from(containerRef.children).slice(0, -4).forEach((item, index) => {
...
function GalleryGrid({
  ...
  const [height, setHeight] = useState(5e4);
...
const $$$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "image": cave }, { "default": ($$result2) => renderTemplate`
    ${renderComponent($$result2, "PageWrapper", PageWrapper, { "title": globalData?.sectionNames[language].artists || "Artist", "main": globalData?.layoutData.navList[language][0].text || "Main" }, { "default": ($$result3) => renderTemplate`
        ${renderComponent($$result3, "ArtistPage", ArtistPage, { "client:load": true, "formTitle": globalData?.sectionNames[language].form || "Book an appointment", "cta": globalData?.buttons[language].cta || "book an appointment", "formData": globalData?.formData[language] || null, "data": artist, "imagesData": imagesData?.filter((item) => artist ? item.filters.artists === artist.key : false) || [], "language": language, "client:component-hydration": "load", "client:component-path": "pageComponents/ArtistPage/ArtistPage", "client:component-export": "ArtistPage" })}
    ` })}
` })}`;
