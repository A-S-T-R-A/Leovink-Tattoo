...
import 'html-escaper';
import { T as Typography, a as PlusIcon, b as classNames, g as getLangFromUrl, d as fetchSectionData, f as fetchGlobalData, P as PageWrapper, S as Section, c as cave, $ as $$Layout } from './_...artistSlug_.astro.91cf3a92.mjs';
...
const $$Faq$2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "image": cave }, { "default": ($$result2) => renderTemplate`
    ${renderComponent($$result2, "PageWrapper", PageWrapper, { "title": globalData?.layoutData.navList[language][2].text || "FAQ", "main": globalData?.layoutData.navList[language][0].text || "Main" }, { "default": ($$result3) => renderTemplate`
        ${renderComponent($$result3, "Section", Section, {}, { "default": ($$result4) => renderTemplate`
            ${renderComponent($$result4, "FAQPage", FAQPage, { "client:load": true, "data": faqData?.filter((item) => item.title !== "index") || null, "client:component-hydration": "load", "client:component-path": "pageComponents/FAQPage/FAQPage", "client:component-export": "FAQPage" })}
        ` })}
